...
//about an object’s data type at runtime and is available only for the 
//classes which have at least one virtual function. It allows the type of 
...
/*For example, dynamic_cast uses RTTI and following program fails with error
 ...
 (source type is not polymorphic) ” because there is no virtual 
...
*/
//adding a virtual function to base class B makes it working
#include<iostream>
using namespace std;
